...
-- | Oakley Group 2 from RFC 2409.
--
-- Yes, it's really called Group *2* when defined in RFC 2409 and
-- called Group *1* when specified in SSH in RFC 4253 Section 8.1.
group1 :: DH.Params
group1 = DH.Params
