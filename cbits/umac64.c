...
static
void uhash_reset(uhash_ctx_t pc)
{
    nh_reset(&pc->hash);
    pc->msg_len = 0;
    pc->poly_accum[0] = 1;
...
static
void uhash_update(uhash_ctx_t ctx, const char *input, long len)
...
static
void uhash_final(uhash_ctx_t ctx, char *res)
...
static
void uhash(uhash_ctx_t ahc, const char *msg, long len, char *res)
